...
<body >
<h1 style="margin-top: 30px; font-family: 'Baskerville Old Face'; text-align: center; font-size: 50px">Add Service Room</h1>
<form method="post"  action="/service?action=add" style="margin-left: 150px; margin-right: 150px">

    <input name="service_type_id" hidden type="text"  value="3">
    <div class="mb-4">
    ...
    <div class="form-row" hidden>
        <div class="col-md-6 mb-4">
            ...
            <input name="standard_room"  type="number" class="form-control"  value="0"  placeholder="standard_room">
        </div>
        <div class="col-md-6 mb-4">
            <label >number_of_floors</label>
            <input name="number_of_floors"   type="number" class="form-control"  value="0"  placeholder="number_of_floors">
        </div>
    </div>
    ...
    <div class="form-row" hidden>
        <div class="col-md-6 mb-4">
            ...
            <input name="pool_area" type="number" hidden class="form-control"  value="0"  placeholder="pool_area">
        </div>
        <div class="col-md-6 mb-4">
            <label >description_other_convenience</label>
            <input name="description_other_convenience"  hidden type="text" class="form-control"  value=""   placeholder="description_other_convenience">
        </div>
    </div>
