...
<button type="button" class="btn btn-info" style="width: 80px;"><a href="/products?action=create&id=${product.getId()}" style="text-decoration: none; color: white">Edit</a></button>
